...
const TaskCheckBoxComponent = () => {
  ...
  const data = [
    {title: 'Tito’s',handle: '1x Handle',text: 'Completed',time: '7:00',id: '1',},
    {title: 'Keystone',handle: '2x Racks',text: 'Completed',time: '8:30',id: '2',},
    {title: 'Whiteclaw',handle: '2x Cases',text: 'Completed',time: '8:30',id: '3',},
    {title: 'Tequilla',handle: '1x Handle',text: 'Completed',time: '8:30',id: '4',},
  ];
